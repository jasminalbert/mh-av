...
for (i in 1:2){
  for (j in 1:2){
    ...
    lines(1:t+.5,sp2[i,j,"dispered",1:t],type='b',col=cols2[3],lwd=0.5,pch=17)
    lines(1:t+.5,sp10[i,j,"dispered",1:t],type='b',col=cols1[3],lwd=0.5,pch=2,lty=3,cex=0.7)
    lines(1:t+.5,sp20[i,j,"dispered",1:t],type='b',col=cols2[3],lwd=0.5,pch=2,lty=3,cex=0.7)
    lines(sp1[i,j,"inds",1:t],type='b',col=cols1[1])
    lines(1:t,sp2[i,j,"inds",1:t],type='b',col=cols2[1])
    lines(sp10[i,j,"inds",1:t],type='b',lty=2,col=cols1[1])
    lines(1:t,sp20[i,j,"inds",1:t],type='b',col=cols2[1],lty=2)
    points(1:t+.2,sp1[i,j,"seeds",1:t],pch=18,col=cols1[2])
    points(1:t+.2,sp2[i,j,"seeds",1:t],pch=18,col=cols2[2])
    points(1:t+.2,sp10[i,j,"seeds",1:t],pch=5,col=cols1[2],cex=0.7)
    points(1:t+.2,sp20[i,j,"seeds",1:t],pch=5,col=cols2[2],cex=0.7)
