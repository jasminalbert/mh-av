...
N <- pmin(rnorm(gridsize^2,0.75,0.1)+0.001,0.999)
N20 <- N10 <- matrix(1:gridsize^2,ncol=gridsize)
N10[N10%%2==1] <- sample(N,sum(N10%%2))
N10[N10>1] <- 0
N20[N10==0] <- N[!N%in%N10]
N20[N10!=0] <- 0
...
fig <- paste0("../../figures/test3theta1.pdf" )
#pdf(fig,width=12)
